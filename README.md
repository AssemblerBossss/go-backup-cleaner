...
CLI-инструмент для автоматической очистки старых бэкапов: удаляет самые старые файлы в указанной директории,
пока не будет достигнуто одно из заданных ограничений (свободное место, процент занятости диска,
максимальный размер каталога или максимальный возраст файлов).

## Возможности

- Поддерживает нужный объём свободного места, удаляя старые файлы
- Работает по временным окнам вместо хранения списка файлов целиком в памяти
